var _ = require("underscore"),
	...
	Strategy = require("passport-assetorium").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/assetorium/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('assetorium', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('assetorium', arguments[0]);
		}
	},
